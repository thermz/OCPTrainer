 ...
 * @author Riccardo
 */
public class DequeTrainerPane extends javax.swing.JPanel {
	...
	private Integer getOrRandomizeInput(){
		if(isRandom()){
			inputT.setText( String.valueOf( getRandomNumber(0, 100) ) );
		}
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Deque head");

        jLabel6.setText("Deque tail");
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                            ...
                                            .addGap(18, 18, 18)
                                            .addComponent(latestOutput, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(layout.createSequentialGroup()
    ...
    private void getBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_getBActionPerformed
		throw new UnsupportedOperationException("There is no get() method in ArrayDeque");
...
//		}
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new DequeTrainerPane().setVisible(true);
			}
		});
	}
